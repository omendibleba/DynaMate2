def download_mace_model(model_name: str,
    ...
    if model_dict is None:
        model_dict = {
            ...
            "MACE-POLAR-M:": "https://github.com/ACEsuit/mace-foundations/releases/download/mace_polar_1/MACE-POLAR-1-M.model",
        }
    ...
    if convert_lmp:
        ...
        os.system(f"python /groups/ycolon/Orlando/Programs/mace/mace/cli/create_lammps_model.py {out_path}")
